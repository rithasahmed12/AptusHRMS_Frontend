      ...
      {!isMobile && (
        <div className="flex justify-center items-center w-1/2">
          <div className="w-96 h-96">
            <img src={adminBackground} alt="Illustration" className="w-full h-full object-cover" />
          </div>
        </div>
      )}
      <div className={`flex justify-center items-center ${isMobile ? 'w-full px-4 my-4' : 'w-1/2'}`}>
        <div className="h-[500px] w-[400px] bg-white shadow-lg rounded-lg flex flex-col justify-center">
          <h2 className="mb-8 text-xl font-semibold text-center">Admin Login</h2>
          <form className="w-full" onSubmit={handleSubmit}>
            ...
            <div className="mb-10 mx-7 relative">
              ...
              >
                {showPassword ?  <EyeIcon height={20} color='#ff6b5a'/> : <EyeSlashIcon height={20} color='#ff6b5a'/> }
              </button>
            </div>
            <div className="mb-2 mx-9">
              <button type="submit" className="w-full py-1 bg-[#ff6b5a] text-white rounded-full hover:bg-[#ffa497] transform duration-500">
                Login
              </button>
            </div>
          </form>
